...
public:
     ...
     */
    std::size_t max_loops = 200;      ///< Maximal number of preprocessing iterations
    ...
    std::size_t max_clause_size = 256; ///< Maximal size for an extended clause by hidden or covered extension
    ...
    int max_resolution_cost = 1;      ///< Maximal increase of the number of literals in the formula by resolution
    ...
    std::size_t num_random_patterns = 0; ///< Number of random patters for incomplete UNSAT checks
    ...
    std::size_t max_expansion_size = 0; ///< Maximal expansion size. This value is set and used during universal expansion
    ...
    bool extend_gates = false;        ///< Add blocked implications and transitive implications to get more gates

    el::base::type::VerboseLevel verbosity = 0; ///< Amount of information to print on the screen
...
#ifdef SKOLEM
    bool skolem = true;               ///< Enable the computation of Skolem functions
#endif
    //@}
};
